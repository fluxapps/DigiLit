...
class xdglLibraryGUI
{
    ...
    public function executeCommand()
    {
        ...
        switch ($cmd) {
            ...
            case self::CMD_PERFORM_LIBRARY_ASSIGNEMENT:
                ...
                $this->tabs_gui->setBackTarget($this->pl->txt('library_back'),
    ...
    protected function assignLibrary()
    {
        ...
        $se->setOptions(array_merge(array(0 => $this->pl->txt('librarian_none')),
            xdglLibrarian::getAssignedLibrariansForLibrary()));
        $form->addItem($se);
    ...
    protected function performLibraryAssignment()
    {
        ...
        $xdglLibrarian = xdglLibrarian::findLibrarian($_POST['librarian_select'], $_POST['library_select']);
